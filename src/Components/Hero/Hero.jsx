...
const HeroData = [
    {
        ...
        title: "Wireless",
        title2: "Headphone",
        description: "Lorem ipsum dolor sit amet consectetur adipisicingelit. Officiis, dolorem libero. Quia eveniet facere aut adipisci repudiandae. Voluptates,iure veniam nihil officia magni in maxime, at dignissimos alias non illo! "
    },
    {
        id:2,
        img: Image2,
                    ...
                    <div key={data.id}>
                        <div className='grid grid-cols-1 sm:grid-cols-2'>
                            ...
                            <div className='order-2 sm:order-2'>
                                ...
                                src={data.img} 
                                alt=""
                                className='w-[300px] h-[300px] sm:h-[300px] sm:w-[450px]
