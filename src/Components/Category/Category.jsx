    ...
    <div className='py-8'>
      <div className='container'>
        ...
        lg:grid-cols-4 gap-8'>
            ...
            from-black/90 to-black/70 text-white rounded-3xl
            ...
            {/* second col  */}
            <div className='py-10 pl-5 bg-gradient-to-br 
            from-brandYellow/90 to-brandYellow/70 text-white rounded-3xl
            relative h-[320px] flex items-end'>
              <div>
                <div className='mb-4'>
            ...
            from-primary/90 to-primary/70 text-white rounded-3xl
            relative h-[320px] flex items-end'>
              <div>
                <div className='mb-4'>
                  <p className='mb-[2px] text-white'>Enjoy</p>
